    ...
    public partial class SelectBookList : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (key)
            {
                ...
                case "出版社":
                    condition = String.Format(" and publisher like '%{0}%'", valuel); break;
                case "出版年份":
                    condition = String.Format(" and publishTime like '%{0}%'", valuel); break;
                case "状态":
                    condition = String.Format(" and bookstate like '%{0}%'", valuel); break;
                case "库存数目":
                    condition = String.Format(" and num  = {0}", valuel); break;
                case "借出数目":
                    condition = String.Format(" and lendnum = {0}", valuel); break;
            }
            string sql = "select a.ISBN as ISBN, a.BookName as 书名,b.bCategoryname as 图书类别名称, a.author as 第一作者, a.publisher as 第一出版社,"
                    + " a.publishTime as 出版年份, a.bookstate as 状态, a.num as 库存数目, a.lendnum as 借出数目 "
